...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'Vehicle Addition.create': {
    roles: ['owner', 'admin', 'operations-manager', 'customer-service-representative', 'operations-staff'],
    key: 'vehicle_addition',
    tenantPath: [],
    userPath: [],
  },
  'Vehicle Assignment.update': {
    roles: ['owner', 'admin', 'fleet-manager', 'customer-service-representative', 'operations-staff'],
    key: 'vehicle_assignment',
    tenantPath: [],
    userPath: [],
  },
  'Complaint Resolution.update': {
    roles: ['owner', 'admin', 'fleet-manager', 'operations-manager', 'operations-staff'],
